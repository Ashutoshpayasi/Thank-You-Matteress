...
<!-- Mirrored from templates.hibootstrap.com/xton/default/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 05:00:44 GMT -->
...
<head>
  ...
  <title>Thank You Mattress</title>
...
<body>
      ...
      <div class="row">
        ...
        <div class="col-lg-6 col-md-12">
          <div class="about-content">
            <span class="sub-title">PRESTIGE COIR (INDIA) PRIVATE LIMITED</span>
            <p>
              The company <strong>PRESTIGE COIR (INDIA) PRIVATE LIMITED</strong> was
              established in year 1995 by team of experienced and professionally qualified family.
            </p>
            <p>
              After having created their NICHE in commercial market, hotels, hostels, hospitals & in railways,
              the management with passage of time emphasized and felt the need to develop and enter the ARENA of
              “DIRECT MARKETING NETWORK” (DMN) in the year 2012, so as the existing and new customers can benefit
              the maximum in highly competitive market and they get RIGHT VALUE FOR THEIR MONEY for the type and price range of Mattress they desire, comparing
              best to match with super brands in quality, warranty and prices.
            </p>
            <p>
              The company proposed to promote the strategy of DMN in such a way as to give maximum
              benefits
              and maintain LIFE LONG direct relations with it’s customers.
            </p>
            <div class="features-text">
              <h5>
                YEAR OF INCORPORATION – 1995 <br>
                REGISTRATION'S – MSME, CIN, GSTIN, ISO <br>
                CELEBRATING 28 YEARS OF BUSINESS <br>
                ABOUT DIRECTOR – Mr. PARMINDER SINGH KINDRA (B.com (Hons), FCA ) <br>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="about-image">
            <img src="assets/img/about/aboutimg.jpg" class="shadow" alt="image" />
          </div>
        </div>
  ...
  <section class="products-area pt-20 pb-70">
    <div class="container">
      <div class="section-title">
        <h2 style="margin: 25px;">Our Products</h2>
      </div>
      <div class="row justify-content-center">
          ...
          <div class="single-products-box">
            <div class="products-image">
              <a href="products-type-1.php">
                <img src="assets\img\payment\0722090811485801p4 (3).jpg" class="main-image" alt="image">
                <img src="assets\img\payment\0722090811485801p4 (3).jpg" class="hover-image" alt="image">
              </a>
  ...
  <section class="blog-area pt-100 pb-70">
    <div class="container">
      <div class="section-title">
        ...
        <h2>From The Thank You Mattress Blog</h2>
      </div>
      <div class="row justify-content-center">
        ...
        <div class="modal-body">
          <div class="sidebar-about-content">
            ...
            <div class="about-the-store">
              <p>The company PRESTIGE COIR (INDIA) PRIVATE LIMITED was established in year 1995 by team of experienced and professionally qualified family.
                After having created their NICHE in commercial market, hotels, hostels, hosp</p>
              <ul class="sidebar-contact-info">
                ...
                <li><i class="bx bx-envelope"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#deb6bbb2b2b19ea6aab1b0f0bdb1b3"><span class="__cf_email__" data-cfemail="5139343d3d3e1129253e3f7f323e3c">[email&#160;protected]</span></a></li>
              </ul>
            </div>
...
<!-- Mirrored from templates.hibootstrap.com/xton/default/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 05:03:40 GMT -->
