...
<!-- Mirrored from templates.hibootstrap.com/xton/default/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 05:04:05 GMT -->
                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item"><a href="#" class="nav-link active">Home <i class="bx bx-chevron-down"></i></a>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="index-2.php" class="nav-link active">Home 2</a></li>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-md-12">
                                <div class="banner-content text-white">
                                    ...
                                    <div class="btn-box">
                                        <a href="products-right-sidebar-2.php" class="default-btn">Shop Women's</a>
                                        <a href="products-right-sidebar-3.php" class="optional-btn">Shop Men's</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            ...
                            <h3><a href="products-type-2.php">Long Sleeve Leopard T-Shirt</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">T-Shirt</span>
                            <h3><a href="products-type-2.php">Causal V-Neck Soft Raglan</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            ...
                            <h3><a href="products-type-2.php">Hanes Men's Pullover</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            ...
                            <h3><a href="products-type-2.php">Gildan Men's Crew T-Shirt</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            ...
                            <h3><a href="products-type-2.php">Yidarton Women's Comfy</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            ...
                            <h3><a href="products-type-2.php">Womens Tops Color</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-6 offset-lg-7 ">
                    <div class="offer-content-box">
                        ...
                        <a href="products-right-sidebar.php" class="default-btn">Discover Now</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">T-Shirt</span>
                            <h3><a href="products-type-2.php">Tbmpoy Men's Tapered</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">T-Shirt</span>
                            <h3><a href="products-type-2.php">Sunnyme Women's Ponchos</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Shirt</span>
                            <h3><a href="products-type-2.php">Open Front Knit Sweaters</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Twist Shirt</span>
                            <h3><a href="products-type-2.php">Block Striped Draped</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Smart Shirt</span>
                            <h3><a href="products-type-2.php">Fleece Hooded Sweatshirt</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">EcoSmart</span>
                            <h3><a href="products-type-2.php">Women's Modern-Skinny</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">T-Shirt</span>
                            <h3><a href="products-type-2.php">Sleeve Faux Suede Loose</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">T-Shirt</span>
                            <h3><a href="products-type-2.php">T-Shirt Casual Stripe Tunic</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Shirt</span>
                            <h3><a href="products-type-2.php">Chest Cutout Tunics Long</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Twist Shirt</span>
                            <h3><a href="products-type-2.php">Twist Knotted Tops</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">Smart Shirt</span>
                            <h3><a href="products-type-2.php">Premium Lightweight Fleece</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="products-box">
                        ...
                        <div class="products-content">
                            <span class="category">EcoSmart</span>
                            <h3><a href="products-type-2.php">EcoSmart Fleece Hoodie</a></h3>
                            <div class="star-rating">
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                                <i class="bx bxs-star"></i>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog-2.php">The #1 eCommerce blog to grow your business</a></h3>
                            <a href="single-blog-2.php" class="details-btn">Read Story</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog-2.php">Latest ecommerce trend: The rise of shoppable posts</a></h3>
                            <a href="single-blog-2.php" class="details-btn">Read Story</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-post">
                        ...
                        <div class="post-content">
                            ...
                            <h3><a href="single-blog-2.php">Building eCommerce wave: Social media shopping</a></h3>
                            <a href="single-blog-2.php" class="details-btn">Read Story</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sidebar-about-content">
                        ...
                        <div class="about-the-store">
                            ...
                            <ul class="sidebar-contact-info">
                                ...
                                <li><i class="bx bx-envelope"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#a1c9c4cdcdcee1d9d5cecf8fc2cecc"><span class="__cf_email__" data-cfemail="bed6dbd2d2d1fec6cad1d090ddd1d3">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    ...
                    <div class="single-footer-widget">
                        ...
                        <div class="about-the-store">
                            ...
                            <ul class="footer-contact-info">
                                <li><i class="bx bx-map"></i> <a href="#" target="_blank">Wonder Street, USA, New York</a></li>
                                <li><i class="bx bx-phone-call"></i> <a href="tel:+01321654214">+01 321 654 214</a></li>
                                <li><i class="bx bx-envelope"></i> <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#19717c75757659616d7677377a7674"><span class="__cf_email__" data-cfemail="90f8f5fcfcffd0e8e4fffebef3fffd">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                        <ul class="social-link">
                            <li><a href="https://www.facebook.com/" class="d-block" target="_blank"><i class="bx bxl-facebook"></i></a></li>
...
<!-- Mirrored from templates.hibootstrap.com/xton/default/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Sep 2024 05:04:09 GMT -->
